...
def infoExtract(URL):
    ...
    if (pagetoken == None):
        ...
        nextPage = "https://www.googleapis.com/youtube/v3/videos?part=id,statistics,                                                            snippet&chart=mostPopular&regionCode=IN&maxResults=50&pageToken={}&key=[API-KEY]".format(pagetoken)
        infoExtract(nextPage)


initURL = "https://www.googleapis.com/youtube/v3/videos?part=id,statistics,                                                            snippet&chart=mostPopular&regionCode=IN&maxResults=50&key=[API-KEY]"
